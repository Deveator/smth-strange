...
public class MaxLengthPasswordPositive extends Help {
	...
	static String positivePsswrd = "1234567";

	//public static void main(String[] args) {
		
		public static void mMaxLengthPasswordPositive() {
		...
		configSettingsPage.set_8_InMaxLengthPassword();
