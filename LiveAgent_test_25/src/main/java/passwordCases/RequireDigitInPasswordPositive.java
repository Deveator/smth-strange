...
public class RequireDigitInPasswordPositive extends Help{
...
//	public static void main(String[] args) {
		...
		public static void mRequireDigitInPasswordPositive() {
		...
		configSettingsPage.setRequireDigitInPassword();
