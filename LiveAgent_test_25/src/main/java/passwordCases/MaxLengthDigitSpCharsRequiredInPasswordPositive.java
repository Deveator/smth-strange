...
public class MaxLengthDigitSpCharsRequiredInPasswordPositive extends Help{
	...
	static String positivePsswrd = "12345!";

	//public static void main(String[] args) {
		
		public static void mMaxLengthDigitSpCharsRequiredInPasswordPositive() {
