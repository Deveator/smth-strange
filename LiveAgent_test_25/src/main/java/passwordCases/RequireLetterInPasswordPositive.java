...
public class RequireLetterInPasswordPositive extends Help{
	...
	private static String positivePsswrd = "12345z";

//	public static void main(String[] args) {
		
		public static void mRequireLetterInPasswordPositive() {
