...
public class RequireSpecCharsInPasswordPositive extends Help{
	...
	//public static void main(String[] args) {
		...
		public static void mRequireSpecCharsInPasswordPositive() {
		...
		configSettingsPage.setRequireSpecCharsInPassword();
