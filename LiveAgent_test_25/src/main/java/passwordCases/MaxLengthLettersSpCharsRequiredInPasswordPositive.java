...
public class MaxLengthLettersSpCharsRequiredInPasswordPositive extends Help{
	...
	private static String positivePsswrd = "1234!z";

	//public static void main(String[] args) {
		
		public static void mMaxLengthLettersSpCharsRequiredInPasswordPositive() {
		...
		setNewPassword4NewAgentPage.createPassword4NewAgent(positivePsswrd);
		startPage.approveLogin(gotItMark, agentName);
		startPage.logout();
		loginPage.approveLogout(requiredNameOfUser);
		loginPage.login(loginEmail, loginPassword, englishLang, englishNum);	
		startPage.approveLogin(gotItMark, requiredNameOfUser);
