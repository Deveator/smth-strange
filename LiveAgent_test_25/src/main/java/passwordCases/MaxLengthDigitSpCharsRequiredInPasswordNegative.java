...
public class MaxLengthDigitSpCharsRequiredInPasswordNegative extends Help{
	...
	static String negativePsswrd = "12345";
	static String negativePsswrd_2 = "!!!!!";
	static String negativePsswrd_3 = "12345!!!!!";

	//public static void main(String[] args) {
		
		public static void mMaxLengthDigitSpCharsRequiredInPasswordNegative() {
		...
		configSettingsPage.set_8_InMaxLengthAndCheckDigitAndSpCharsPassword();
