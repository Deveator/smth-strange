...
public class MinLengthDigitLetterRequiredInPasswordNegative extends Help {
	...
	private static String negativePsswrd_2 = "zzzzz";
	private static String negativePsswrd_3 = "zzz1";

	// public static void main(String[] args) {

	public static void mMinLengthDigitLetterRequiredInPasswordNegative() {
		...
		configSettingsPage.set_5_InMinLengthAndCheckLetterAndDigitPassword();
