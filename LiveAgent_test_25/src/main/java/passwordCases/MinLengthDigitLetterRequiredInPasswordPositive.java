...
public class MinLengthDigitLetterRequiredInPasswordPositive extends Help {
	...
	static String positivePsswrd = "12345z";

	// public static void main(String[] args) {

	public static void mMinLengthDigitLetterRequiredInPasswordPositive() {
