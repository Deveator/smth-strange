...
public class MaxLengthLettersSpCharsRequiredInPasswordNegative extends Help{
	...
	private static String negativePsswrd = "zzzzz";
	private static String negativePsswrd_2 = "!!!!!";
	private static String negativePsswrd_3 = "zzzzz!!!!!";

	//public static void main(String[] args) {
		
		public static void mMaxLengthLettersSpCharsRequiredInPasswordNegative() {
		...
		configSettingsPage.set_8_InMaxLengthAndCheckLetterAndSpCharsPassword();
		...
		setNewPassword4NewAgentPage.createPassword4NewAgent(negativePsswrd_2);
		setNewPassword4NewAgentPage.verifyPresenceOfErrorMessage();
		setNewPassword4NewAgentPage.createPassword4NewAgent(negativePsswrd_3);
		setNewPassword4NewAgentPage.verifyPresenceOfErrorMessage();
		driver.get(testedUrl_loginPage);
		loginPage.login(loginEmail, loginPassword, englishLang, englishNum);	
		startPage.approveLogin(gotItMark, requiredNameOfUser);
